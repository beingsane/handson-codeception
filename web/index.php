  ...
  <nav class="light-blue lighten-1" role="navigation">
    <div class="nav-wrapper container">
      ...
      <ul class="right hide-on-med-and-down">
        ...
        <li><a onclick="confirm('Tem certeza?'); alert('Faça login antes');" id="meuspedidos">Meus pedidos</a></li>
      </ul>
    </div>
  </nav>
  <div class="section no-pad-bot" id="index-banner">
    <div class="container">
    	<?php 
    		...
    		$resposta = $client->get(
    			"http://localhost:8888/qualister-php-testing/api/",
    			['auth' => ['phptesting', '123']
    		]);
	    ...
	    <div class="center" id="mensagem-magica" style="display: none">Você é paciente!</div>
    </div>
  </div>
